...
parser$add_argument("--sensitivity", action="store_true", help="Sensitivity")
...
parser$add_argument("--n", type="integer", help="Number of iterations (MR-PRESSO)")
parser$add_argument("--datafile", type="character", help="Path to the clumped data")
...
MR <- function(args$datafile, args$path, args$action, args$ref_3kg_path, args$sensitivity, args$n, args$plink19_path){
