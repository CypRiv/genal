...
def lift_data(data, start="hg19",end="hg38", replace=False, extraction_file=False, chain_file="", name="", genal_tools_path=""):
    ...
    if chain_file!="": #If user provides path to a local chain path
        ...
        chain_path = "tmp_GENAL/" if genal_tools_path == "" else f"{genal_tools_path}chain_files/"
